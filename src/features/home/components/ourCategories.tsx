  ...
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/categories" className="text-green-600 font-medium flex items-center gap-1 hover:gap-2 transition-all">
          View All Categories
        ...
        {response?.data.map((category) => (
          ...
          >
            <div className="w-20 h-20 rounded-full bg-white overflow-hidden flex items-center justify-center mx-auto ">
              <Image src={category.image} alt={category.name} width={300} height={300} className="w-full h-full object-cover " />
            </div>
